...
public class ExternalSort {
        ...
        public static int mergeSortedFiles(List<File> files, File outputfile,
                ...
                for (File f : files)
                        f.delete();         //to find temporary files
                return rowcounter;
        }
        ...
        public static Comparator<String> defaultcomparator = new Comparator<String>() {
                ...
                public int compare(String r1, String r2) {
                    ...
                    Pattern checkRegex = Pattern.compile("[a-zA-Z]{1,}");
                    Matcher StringMatcher1 = checkRegex.matcher( r1 );
                    Matcher StringMatcher2 = checkRegex.matcher( r2 );
                    if(StringMatcher1.find()&&StringMatcher2.find())
                    {
                        s1 = StringMatcher1.group();
                        s2 = StringMatcher2.group();
                    }
                    try{
                    ...
                    int a1=0,a2=0;
                    Pattern intRegex = Pattern.compile("[0-9]{1,}");
                    Matcher intMatcher1 = intRegex.matcher( r1 );
                    Matcher intMatcher2 = intRegex.matcher( r2 );
                    if(intMatcher1.find()&&intMatcher2.find())
                    {
                        a1 = Integer.parseInt(intMatcher1.group());
                        a2 = Integer.parseInt(intMatcher2.group());
                    }
                    if(a1 > a2 )
                        return 2;
                    return -2;
